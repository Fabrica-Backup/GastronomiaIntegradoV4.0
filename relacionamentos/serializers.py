...
class CreateReceitaSerializer(serializers.ModelSerializer):
    ...
    def validade(self, data):
        ...
        if nome_receita_qs.exists():
            ...
            raise serializers.ValidationError(
                'O nome da receita não pode ter mais de 100 caracteres')
        return data
...
class CreateIngredienteSerializer(serializers.ModelSerializer):
    ...
    print("oi print create ingrediente")
    ...
    def validate(self, data):
        ...
        quantidade_calorica_ingrediente = Decimal(
            data['quantidade_calorica_ingrediente'])
        aproveitamento_ingrediente = Decimal(
            data['aproveitamento_ingrediente'])
        ...
        if nome_qs.exists():
            ...
            raise serializers.ValidationError(
                'O campo quantidade calorica não pode ser negativo')
        elif aproveitamento_ingrediente < 0:
            raise serializers.ValidationError(
                'O campo aproveitamento ingrediente não pode ser negativo')
        elif aproveitamento_ingrediente > 100:
            raise serializers.ValidationError(
                'O aproveitamento não pode ser acima de 100')
        return data
...
class EditIngredienteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ingrediente
        print("oi edit serializer ingrediente")
        fields = [
            'id_ingrediente',
            'nome_ingrediente',
            'quantidade_calorica_ingrediente',
    ...
    def validate(self, data):
        ...
        if quantidade_calorica_ingrediente < 0:
            ...
            raise serializers.ValidationError(
                'O Campo aproveitamento não pode ser negativo')
        elif aproveitamento_ingrediente > 100:
            raise serializers.ValidationError(
                'O aproveitamento não pode ser acima de 100')
        elif valor_ingrediente < 0:
            raise serializers.ValidationError(
                'O campo valor ingrediente não pode ser negativo')
        return data

    def update(self, instance, validated_data):
        instance.nome_ingrediente = validated_data.get(
            'nome_ingrediente', instance.nome_ingrediente)
        instance.quantidade_calorica_ingrediente = validated_data.get(
            'quantidade_calorica_ingrediente', instance.quantidade_calorica_ingrediente)
        instance.aproveitamento_ingrediente = validated_data.get(
            'aproveitamento_ingrediente', instance.aproveitamento_ingrediente)
        instance.valor_ingrediente = validated_data.get(
            'valor_ingrediente', instance.valor_ingrediente)
        instance.motivo_retirada_estoque = validated_data.get(
            'motivo_retirada_estoque', instance.motivo_retirada_estoque)

        if validated_data.get('quantidade_estoque_ingrediente') > 0:
            print("SOMANDO")
            instance.quantidade_estoque_ingrediente = validated_data.get(
                'quantidade_estoque_ingrediente') + instance.quantidade_estoque_ingrediente
        elif validated_data.get('quantidade_estoque_ingrediente') < 0:
            instance.quantidade_estoque_ingrediente = instance.quantidade_estoque_ingrediente + \
                validated_data.get('quantidade_estoque_ingrediente')
            ...
            print("EDITANDO")
            quantidade_estoque_ingrediente = validated_data.get(
                'quantidade_estoque_ingrediente', instance.quantidade_estoque_ingrediente)
        instance.save()
        return instance
